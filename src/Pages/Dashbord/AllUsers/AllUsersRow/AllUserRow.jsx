...
import admin from '../../../../assets/icon/admn.png'
import toast from 'react-hot-toast';
import userUsers from '../../../../Hooks/useUsers';

const AllUserRow = ({ user, userCount }) => {

    const { _id, name, email } = user
    const [,,refetch] = userUsers();
    //handle make Admin 
    ...
    return (
        <tr class="bg-white border-b-2 hover:bg-gray-50 dark:hover:bg-[#cbd5e1] ">
            <td class="w-4 p-4">
                <div class="flex items-center">
                    <p className='text-black font-bold text-lg'>{userCount}</p>
                </div>
            </td>
            ...
            <td class="px-6 py-4 font-semibold text-gray-900">

                {
                    user.role === 'admin' ?
                        // Admin button
                        <button className='btn  hover:bg-slate-200 '>
            ...
            <td class="px-6 py-4 font-semibold text-gray-900">
                <button onClick={()=>handleDelete(_id)} className="btn btn-md font-medium text-white bg-red-700 hover:bg-red-700">
