...
const Dashboard = () => {
    ...
    //TODO: load data from the server to have dynamic is admin based Data 
    const isAdmin =false;
                                ...
                                <ul className="space-y-2 font-medium ">
                                    ...
                                    <li>
                                        <NavLink to="/dashboard/managebookings" className="flex items-center p-2 text-gray-900 hover:text-white rounded-lg  hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                            ...
                                            <span className="inline-flex items-center justify-center w-3 h-3 p-3 ml-3 text-sm font-medium text-black bg-blue-100 rounded-full  ">{cart?.length || 0}</span>
                                        </NavLink>
                                    </li>
                                    <li>
                                ...
                                <ul className="space-y-2 font-medium ">
                                    ...
                                    <li>
                                        <NavLink to="/dashboard/home" className="flex items-center p-2 text-gray-900 hover:text-white rounded-lg  hover:bg-gray-100 dark:hover:bg-gray-700 group">
                                            ...
                                            <span className="flex-1 ml-3 whitespace-nowrap font-bold uppercase">my booking</span>
                                        </NavLink>
                                    </li>
                                    <li>
